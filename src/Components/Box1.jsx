...
<Box sx={{ width: '25%', padding: '20px', display: 'flex', flexDirection: 'column', justifyContent: 'space-between', position: 'relative' }}>  
  ...
  >
    <Typography variant="body1" sx={{ fontFamily: 'Inter', fontSize: '32px', fontWeight: 400, lineHeight: '48px', letterSpacing: '0em', textAlign: 'left', color: 'rgba(7, 71, 134, 1)', borderRadius: '12px', padding: '5px' }}>9.8</Typography>
