    ...
    return (
      ...
      >
        ...
        <Box sx={{ width: '25%', padding: '20px', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center' }}>
          ...
          {/* Typography */}
          <Typography variant="body1" sx={{ fontFamily: 'Inter', fontSize: '13px', fontWeight: 400, lineHeight: '20px', letterSpacing: '0em', textAlign: 'center' }}>Builder 1</Typography>
        </Box>
       ...
       <Box sx={{ width: '50%', padding: '20px' }}>
        ...
        <Box sx={{ width: '490px', height: '72px', top: '368px', left: '525px', padding: '10px', marginBottom: '20px' }}>
          ...
          <strong>WixPro 72-Inch Responsive Website Builder</strong>- Comprehensive Digital Platform Creation Tool, Streamlined Design Interface for Professional Websites and Online Stores (Black/Blue)
          </Typography>
...
<Box sx={{ width: '25%', padding: '20px', display: 'flex', flexDirection: 'column', justifyContent: 'space-between', position: 'relative' }}>  
  ...
  >
    <Typography variant="body1" sx={{ fontFamily: 'Inter', fontSize: '32px', fontWeight: 400, lineHeight: '48px', letterSpacing: '0em', textAlign: 'left', color: 'rgba(7, 71, 134, 1)', borderRadius: '12px', padding: '5px' }}>9.3</Typography>
    <Typography variant="body1" sx={{ fontFamily: 'Inter', fontSize: '14px', fontWeight: 400, lineHeight: '20px', letterSpacing: '0em', textAlign: 'center', color: 'rgba(7, 71, 134, 1)', borderRadius: '12px', padding: '5px' }}>Exceptional</Typography>
